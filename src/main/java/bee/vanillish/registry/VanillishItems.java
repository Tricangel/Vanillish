...
public class VanillishItems {
    ...
    public static final BlockItem SCRAP_METAL_TORCH = registerBlockItem("scrap_metal_torch", properties -> new StandingAndWallBlockItem(VanillishBlocks.SCRAP_METAL_TORCH, VanillishBlocks.SCRAP_METAL_WALL_TORCH, Direction.DOWN, properties), new Item.Properties());
