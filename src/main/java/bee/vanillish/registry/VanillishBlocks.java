...
public class VanillishBlocks {
    ...
    public static final Block BRASS_BRICK_STAIRS = register("brass_brick_stairs", properties -> new StairBlock(BRASS_BRICKS.defaultBlockState(), properties), BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK), true);
    ...
    public static final Block BRASS_TILE_STAIRS = register("brass_tile_stairs", properties -> new StairBlock(BRASS_TILES.defaultBlockState(), properties), BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK), true);
    ...
    public static final Block BRASS_TORCH = register("brass_torch", properties -> new TorchBlock(VanillishParticles.BRASS_FLAME, properties), BlockBehaviour.Properties.ofFullCopy(Blocks.TORCH), false);
    public static final Block BRASS_WALL_TORCH = register("brass_wall_torch", properties -> new WallTorchBlock(VanillishParticles.BRASS_FLAME, properties), BlockBehaviour.Properties.ofFullCopy(Blocks.TORCH), false);
    ...
    public static final Block ROSE_GOLD_TILE_STAIRS = register("rose_gold_tile_stairs", properties -> new StairBlock(ROSE_GOLD_TILES.defaultBlockState(), properties), BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK), true);
    ...
    public static final Block ROSE_GOLD_TORCH = register("rose_gold_torch", properties -> new TorchBlock(VanillishParticles.ROSE_GOLD_FLAME, properties), BlockBehaviour.Properties.ofFullCopy(Blocks.TORCH), false);
    public static final Block ROSE_GOLD_WALL_TORCH = register("rose_gold_wall_torch", properties -> new WallTorchBlock(VanillishParticles.ROSE_GOLD_FLAME, properties), BlockBehaviour.Properties.ofFullCopy(Blocks.TORCH), false);
    ...
    public static final Block STEEL_BRICK_STAIRS = register("steel_brick_stairs", properties -> new StairBlock(STEEL_BRICKS.defaultBlockState(), properties), BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK), true);
    ...
    public static final Block STEEL_TILE_STAIRS = register("steel_tile_stairs", properties -> new StairBlock(STEEL_TILES.defaultBlockState(), properties), BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK), true);
    ...
    public static final Block STEEL_TORCH = register("steel_torch", properties -> new TorchBlock(VanillishParticles.STEEL_FLAME, properties), BlockBehaviour.Properties.ofFullCopy(Blocks.TORCH), false);
    public static final Block STEEL_WALL_TORCH = register("steel_wall_torch", properties -> new WallTorchBlock(VanillishParticles.STEEL_FLAME, properties), BlockBehaviour.Properties.ofFullCopy(Blocks.TORCH), false);
    ...
    public static final Block SCRAP_METAL_BRICK_STAIRS = register("scrap_metal_brick_stairs", properties -> new StairBlock(SCRAP_METAL_BRICKS.defaultBlockState(), properties), BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK), true);
    ...
    public static final Block SCRAP_METAL_TILE_STAIRS = register("scrap_metal_tile_stairs", properties -> new StairBlock(SCRAP_METAL_TILES.defaultBlockState(), properties), BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK), true);
    ...
    public static final Block SCRAP_METAL_TORCH = register("scrap_metal_torch", properties -> new TorchBlock(VanillishParticles.SCRAP_METAL_FLAME, properties), BlockBehaviour.Properties.ofFullCopy(Blocks.TORCH), false);
    public static final Block SCRAP_METAL_WALL_TORCH = register("scrap_metal_wall_torch", properties -> new WallTorchBlock(VanillishParticles.SCRAP_METAL_FLAME, properties), BlockBehaviour.Properties.ofFullCopy(Blocks.TORCH), false);
