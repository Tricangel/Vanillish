        ...
        return new RecipeProvider(provider, recipeOutput) {
            ...
            public void buildRecipes() {
                ...
                nineBlockStorageRecipesRecipesWithCustomUnpacking(
                        RecipeCategory.MISC, VanillishItems.BRASS, RecipeCategory.BUILDING_BLOCKS, VanillishBlocks.BRASS_BLOCK.asItem(), "brass_from_block", "brass"
                );

                nineBlockStorageRecipesRecipesWithCustomUnpacking(
                        RecipeCategory.MISC, VanillishItems.BRASS_NUGGET, RecipeCategory.BUILDING_BLOCKS, VanillishItems.BRASS, "brass_nugget_from_brass", "brass_nuget"
                );

                nineBlockStorageRecipesRecipesWithCustomUnpacking(
                        RecipeCategory.MISC, VanillishItems.SCRAP_METAL_SHARD, RecipeCategory.BUILDING_BLOCKS, VanillishBlocks.SCRAP_METAL_BLOCK.asItem(), "scrap_from_block", "scrap"
                );

                shapeless(RecipeCategory.MISC, VanillishItems.BRASS, 3)
                ...
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VanillishItems.BRASS, VanillishBlocks.BRASS_LADDER);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VanillishItems.BRASS, VanillishBlocks.BRASS_BARS, 2);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VanillishItems.BRASS, VanillishBlocks.BRASS_SCAFFOLDING);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VanillishItems.BRASS, VanillishBlocks.BRASS_CHAIN);
                ...
                nineBlockStorageRecipesRecipesWithCustomUnpacking(
                        RecipeCategory.MISC, VanillishItems.ROSE_GOLD, RecipeCategory.BUILDING_BLOCKS, VanillishBlocks.ROSE_GOLD_BLOCK.asItem(), "rose_gold_from_block", "rose_gold"
                );

                nineBlockStorageRecipesRecipesWithCustomUnpacking(
                        RecipeCategory.MISC, VanillishItems.ROSE_GOLD_NUGGET, RecipeCategory.BUILDING_BLOCKS, VanillishItems.ROSE_GOLD, "rose_gold_from_nugget", "rose_gold_nuget"
                );

                shapeless(RecipeCategory.MISC, VanillishItems.ROSE_GOLD, 4)
                ...
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VanillishItems.ROSE_GOLD, VanillishBlocks.ROSE_GOLD_LADDER);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VanillishItems.ROSE_GOLD, VanillishBlocks.ROSE_GOLD_BARS, 2);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VanillishItems.ROSE_GOLD, VanillishBlocks.ROSE_GOLD_SCAFFOLDING);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VanillishItems.ROSE_GOLD, VanillishBlocks.ROSE_GOLD_CHAIN);
                ...
                this.shaped(RecipeCategory.DECORATIONS, VanillishItems.ROSE_GOLD_TORCH, 4)
                        ...
                        .pattern("X")
                        .pattern("#")
                        .unlockedBy("has_rose_nugget", this.has(VanillishItems.ROSE_GOLD))
                        .save(this.output);

                //----

                nineBlockStorageRecipesRecipesWithCustomUnpacking(
                        RecipeCategory.MISC, VanillishItems.STEEL, RecipeCategory.BUILDING_BLOCKS, VanillishBlocks.STEEL_BLOCK.asItem(), "steel_from_block", "steel"
                );
                nineBlockStorageRecipesRecipesWithCustomUnpacking(
                        RecipeCategory.MISC, VanillishItems.STEEL_NUGGET, RecipeCategory.BUILDING_BLOCKS, VanillishItems.STEEL, "steel_from_nuge", "steel_nugget"
                );


                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VanillishBlocks.STEEL_BLOCK, VanillishBlocks.CARVED_STEEL);
                ...
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VanillishItems.STEEL, VanillishBlocks.STEEL_LADDER);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VanillishItems.STEEL, VanillishBlocks.STEEL_BARS, 2);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VanillishItems.STEEL, VanillishBlocks.STEEL_SCAFFOLDING);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VanillishItems.STEEL, VanillishBlocks.STEEL_CHAIN);
                ...
                shapeless(RecipeCategory.MISC, VanillishItems.SCRAP_METAL_SHARD, 3)
                        .requires(Items.IRON_NUGGET, 2)
                        .requires(VanillishItems.STEEL_NUGGET, 2)
                        .unlockedBy("jumpsacre", has(Items.IRON_NUGGET))
                        .save(recipeOutput, key("scrap_metal_shard"));

                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VanillishBlocks.SCRAP_METAL_BLOCK, VanillishBlocks.CARVED_SCRAP_METAL);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VanillishBlocks.SCRAP_METAL_BLOCK, VanillishBlocks.SCRAP_METAL_TILES);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VanillishBlocks.SCRAP_METAL_BLOCK, VanillishBlocks.SCRAP_METAL_GRATE);
